...
[added a shell script to automate this – could have used a user-data file as well during instance creation.]
...
4. **Add User to Docker Group (to run docker without sudo):**
    ...
    newgrp docker [run this command manually as it will break the installation of other following packages]
    ```
...
[here commands are wrong as printed in md format make it plain text to proceed]
...
3. **Start and Enable Jenkins Service:**
    ...
    ```
[shell script has commands till above – below commands will run manually as requires ec2 IP ]
[to run the above file – “./script.sh” ? needs chmod, “bash script.sh” ? no chmod needed.]
[for chmod - chmod +x system-setup.sh]

[ignore the Jenkins related setup – took it from intellipaat --> refer system-setup.sh]

[COMMANDS TO RUN AFTER SHELL SCRIPT]
~ NEWGRP DOCKER 
AND BELOW ONES
...
#### **Jenkinsfile**
[can’t we do this directly in Jenkins as setup? – check intellipaat lecture for this]
